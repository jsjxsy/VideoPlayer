...
import com.xsy.android.videoplayer.adapter.TeleplayAdapter;
import com.xsy.android.videoplayer.apiservice.ApiService;
import com.xsy.android.videoplayer.model.Teleplay;
import com.xsy.android.videoplayer.model.TeleplayList;

import butterknife.BindView;
import butterknife.OnClick;

public class TeleplayFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener, RecyclerViewExtended.OnLoadMoreListener, OnItemClickListener {
    ...
    private TeleplayAdapter mAdapter;
    ...
    protected void initView() {
        ...
        mAdapter = new TeleplayAdapter(getActivity());
    ...
    private void sendTeleplayRequest() {
        ApiService.getInstance().getTeleplay(new NetworkListener() {
            @Override
            public void onSuccess(String message) {
                ...
                TeleplayList teleplayList = JSON.parseObject(message, TeleplayList.class);
                mAdapter.setArrayList(teleplayList.getTeleplays());
    ...
    public void onItemClick(View view, int position) {
        Teleplay teleplay = mAdapter.getItem(position);
        Intent intent = new Intent(getActivity(), HomeDetailActivity.class);
        intent.putExtra("url", teleplay.getUrl());
        intent.putExtra("type", HomeActivity.TELEPLAY_TYPE);
