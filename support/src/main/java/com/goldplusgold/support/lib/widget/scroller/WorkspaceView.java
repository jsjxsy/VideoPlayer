/**
 * Copyright 2010 Eric Taix (eric.taix@gmail.com) Licensed under the Apache License, Version 2.0
...
/**
 * The workspace is a wide area with a infinite symbols_number of screens. Each screen contains a view. A
 * workspace is meant to be used with a fixed width only.<br/> <br/> This code has been done by
 * using com.android.launcher.Workspace.java
 */
public class WorkspaceView extends ViewGroup {
    ...
    static Bitmap centerToFit(Bitmap bitmap, int width, int height, Context context) {
        ...
        if (bitmapWidth < width || bitmapHeight < height) {
            ...
            int color = Integer.valueOf("00191919", 16);
    ...
    /**
     * Set a new distance that a touch can wander before we think the user is scrolling in pixels
     * slop<br/>
     */
    ...
    /**
     * ViewGroup.dispatchDraw() supports many features we don't need: clip to padding, layout
     * animation, animation listener, disappearing children, etc. The following implementation
     * attempts to fast-track the drawing dispatch by drawing only what we know needs to be drawn.
     */
    @Override
     ...
     */
         ...
         */
                ...
                if (xMoved || yMoved) {
                    ...
                    // Either way, cancelAll any pending longpress
                    if (allowLongPress) {
    ...
    public void setOnPageChangedListener(onPageChangedListener onPageChangedListener) {
        mPageChangeListener = onPageChangedListener;
    }
    ...
    public void scrollToScreen(int whichScreen) {
        if (null != mPageChangeListener) {
            mPageChangeListener.onPageChanged(whichScreen);
        }
