...
//            textPaint.setTextSize(ScreenSizeUtil.dip2px(getContext(), 16));
...
//            eraser2.setStrokeWidth(ScreenSizeUtil.dip2px(getContext(), 28));
...
//            backgroundPaint.setStrokeWidth(ScreenSizeUtil.dip2px(getContext(), 2));
//        }
//        backgroundPaint.setColor(borderColor);
//        setCheckOffset(ScreenSizeUtil.dip2px(getContext(), 1));
...
//                drawRad -= ScreenSizeUtil.dip2px(getContext(),(2) * roundProgressCheckState / progressBounceDiff;
//            } else if (roundProgressCheckState < progressBounceDiff * 2) {
//                drawRad -= ScreenSizeUtil.dip2px(getContext(),2) - ScreenSizeUtil.dip2px(getContext(),2)
...
//                        - ScreenSizeUtil.dip2px(getContext(),1), paint);
//                canvas.drawCircle(paddingLeft + rad, paddingTop + rad, drawRad
//                        - ScreenSizeUtil.dip2px(getContext(),1), backgroundPaint);
//            }
//            paint.setColor(isEnabled() ? normalColor : disabledColor);
//            bitmapCanvas.drawCircle(rad, rad, showBorderInCheckState ? rad - ScreenSizeUtil.dip2px(getContext(),1.2f) : rad,
//                    paint);
//            bitmapCanvas.drawCircle(rad, rad,
//                    showBorderInCheckState
//                            ? (rad - ScreenSizeUtil.dip2px(getContext(),1.2f)) * (1 - roundProgress)
//                            : rad * (1 - roundProgress),
//                    eraser);
...
//                            ScreenSizeUtil.dip2px(getContext(),100), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
