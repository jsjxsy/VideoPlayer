 ...
 */
public class AtmTalkingTabPageIndicator extends HorizontalScrollView implements PageIndicator {
    /**
    ...
    public AtmTalkingTabPageIndicator(Context context) {
        this(context, null);
    }

    public AtmTalkingTabPageIndicator(Context context, AttributeSet attrs) {
        super(context, attrs);
