 ...
 * the License.
 *******************************************************************************/
package com.goldplusgold.support.lib.widget.pulltorefresh;
...
import com.goldplusgold.support.lib.widget.pulltorefresh.internal.CustomLoadingLayout;
import com.goldplusgold.support.lib.widget.pulltorefresh.internal.Utils;
import com.goldplusgold.support.lib.widget.pulltorefresh.internal.FlipLoadingLayout;
import com.goldplusgold.support.lib.widget.pulltorefresh.internal.LoadingLayout;
import com.goldplusgold.support.lib.widget.pulltorefresh.internal.LoadingLayout.OnSuperAddCallback;
import com.goldplusgold.support.lib.widget.pulltorefresh.internal.RotateLoadingLayout;
import com.goldplusgold.support.lib.widget.pulltorefresh.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
     ...
     * class. <p/> Be sure to set the ID of the view in this method, especially if you're using a
    ...
    /**
     * Called when the UI has been to be updated to be in the {@link State#REFRESHING} or {@link
     * State#MANUAL_REFRESHING} state.
     *
    ...
    protected void updateUIForMode() {
        ...
        if (this == mHeaderLayout.getParent()) {
            mHeaderLayout.removeSelf(this);
        }
        if (mMode.showHeaderLoadingLayout()) {
            mHeaderLayout.addSelf(this, 0, lp, new OnSuperAddCallback() {

                @Override
                public void addView(View view, int index, ViewGroup.LayoutParams lp) {
                    addViewInternal(view, index, lp);
                }
            });
        }
        ...
        if (this == mFooterLayout.getParent()) {
            mFooterLayout.removeSelf(this);
        }
        if (mMode.showFooterLoadingLayout()) {
            mFooterLayout.addSelf(this, -1, lp, new OnSuperAddCallback() {
    ...
    public interface OnPullEventListener<V extends View> {
         ...
         *                    <var>state</var> is {@link State#PULL_TO_REFRESH} or {@link
