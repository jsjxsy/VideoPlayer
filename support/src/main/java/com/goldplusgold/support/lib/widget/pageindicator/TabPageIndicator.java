...
public class TabPageIndicator extends HorizontalScrollView implements PageIndicator {
    ...
    private ArrayList<TabView> mArrTabView;
    ...
    public TabPageIndicator(Context context, AttributeSet attrs) {
        ...
        mArrTabView = new ArrayList<TabView>();
    ...
    public void setTitleText(int tabIndex, String text) {
        if (mArrTabView.size() > tabIndex) {
            TabView tv = mArrTabView.get(tabIndex);
            tv.setText(text);
        }
    }
