...
import com.goldplusgold.support.lib.widget.pulltorefresh.internal.EmptyViewMethodAccessor;
import com.goldplusgold.support.lib.widget.pulltorefresh.internal.IndicatorLayout;
...
public abstract class PullToRefreshAdapterViewBase<T extends AbsListView> extends PullToRefreshBase<T> implements
    ...
    /**
     * Sets the Empty View to be used by the Adapter View. <p/> We need it handle it ourselves so
     * that
     * we can Pull-to-Refresh when the Empty View is shown. <p/> Please note, you do
     * <strong>not</strong> usually need to call this method yourself. Calling setEmptyView on the
     * AdapterView will automatically call this method and set everything up. This includes when
     * the
     * Android Framework automatically sets the Empty View based on it's ID.
     *
